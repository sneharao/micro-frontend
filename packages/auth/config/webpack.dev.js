...
const devConfig = {
    ...
    output: {
        publicPath: 'http://localhost:8082/', // Public path for the output files
    },
    devServer: {
    ...
    plugins: [
        ...
        new ModuleFederationPlugin({
            name: 'auth', // Name of the module global variable
            filename: 'remoteEntry.js', // File name to be used for remote entry
            exposes: {
                './AuthApp': './src/bootstrap' // Expose the bootstrap file
            },
